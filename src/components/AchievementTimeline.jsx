        ...
        <div className="flex flex-col gap-20 relative z-10 py-6">
          {achievements.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="flex flex-col sm:flex-row items-center  dark:bg-[#1d1d2e] text-gray-800 dark:text-white-100 rounded-xl shadow-lg overflow-hidden w-full max-w-4xl">
                  <img
                    src={item.image}
                    alt={item.title}
